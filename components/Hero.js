      ...
      <ScrollAnimationWrapper>
          <motion.div
            ...
            variants={scrollAnimation}>
              {reverse && <div className="flex w-full">
            ...
            <div className=" flex flex-col justify-center items-start row-start-2 sm:row-start-1">
              ...
              <p className="text-black-500 mt-4 mb-6" dangerouslySetInnerHTML={{__html: description}} />
                { button && <>
              ...
              {listUser && <div className="relative w-full flex">
                  <ScrollAnimationWrapper

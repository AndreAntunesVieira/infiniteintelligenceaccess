      ...
      <main id="links-instagram">
        <div id="languages">
          <a href="/pt/links-instagram">
            <Image width={30} height={20} src="/bandeira-brazil.png" className={classNames("language-selector", {selected: locale === 'pt'})}/>
          </a>
          <a href="/en/links-instagram">
            <Image width={30} height={20} src="/bandeira-usa.png" className={classNames("language-selector", {selected: locale === 'en'})}/>
          </a>
          <a href="/nl/links-instagram">
            <Image width={30} height={20} src="/bandeira-nl.png" className={classNames("language-selector", {selected: locale === 'nl'})}/>
          </a>
        </div>
        ...
        <ul id="social-media">
          <li>
            <a href="https://www.instagram.com/infiniteintelligenceaccess/" target="_blank">
                <Image src="/cartao_files/3a8d7aacda991695cb3cbe37cfe32d9d.svg" alt="Globe" width={30} height={30}/>
              </a>
          </li>
          <li>
            <a href="https://www.youtube.com/@infiniteintelligenceaccess5673/videos" target="_blank">
                <Image src="/cartao_files/08cd78ea2560593f6c4cc27a1b52fd9c.svg" alt="Globe" width={30} height={30}/>
              </a>
          </li>
          <li>
            <a href="https://www.tiktok.com/@karinerodriguesholistic" target="_blank">
                <Image src="/cartao_files/ae5d41507e04beb3f3466f23c04a36c3.svg" alt="Globe" width={30} height={30}/>
              </a>
          </li>
